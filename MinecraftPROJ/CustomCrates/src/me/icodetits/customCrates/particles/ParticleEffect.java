...
import me.icodetits.customCrates.particles.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
	...
	MOB_AMBIENT_SPELL("mobSpellAmbient", 16, -1, ParticleProperty.COLORABLE),
	WITCH_SPELL("witchMagic", 17, -1),
	...
	private static boolean isColorCorrect(ParticleEffect effect, ParticleColor color) {
		return ((effect == MOB_SPELL || effect == MOB_AMBIENT_SPELL || effect == REDSTONE) && color instanceof OrdinaryColor) || (effect == NOTE && color instanceof NoteColor);
	}
